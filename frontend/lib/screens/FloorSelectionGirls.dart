...
import 'package:host/services/fetching.dart';
          ...
          : SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  buildContainer(context,
                      floorNumber: data[1].floorNumber,
                      bedNumber: data[1].availableBeds),
                  const SizedBox(height: 16.0),
                  buildContainer(context,
                      floorNumber: data[2].floorNumber,
                      bedNumber: data[2].availableBeds),
                  const SizedBox(height: 16.0),
                  buildContainer(context,
                      floorNumber: data[3].floorNumber,
                      bedNumber: data[3].availableBeds),
                  const SizedBox(height: 16.0),
                  buildContainer(context,
                      floorNumber: data[4].floorNumber,
                      bedNumber: data[4].availableBeds),
                ],
              ),
            ),
    );
